...
class PIQA:
    URL = "https://huggingface.co/datasets/DavidNguyen/Data_Language_Pretrain/resolve/main/valid.jsonl?download=true"
    URL_LABELS = "https://huggingface.co/datasets/DavidNguyen/Data_Language_Pretrain/resolve/main/valid-labels.lst?download=true"
