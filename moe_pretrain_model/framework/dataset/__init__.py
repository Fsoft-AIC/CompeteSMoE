...
from .text.commonsenseqa import CommonsenseQA
from .text.openbookqa import OpenBookQA
from .text.race import RACE
from .text.siqa import SIQA
from .text.winogrande import Winogrande
