...
columns = [
...

    {
     ...
     {
        "type": "summary",
        "field": "openbookqa/accuracy/group_average",
        "transform": lambda x: f"{x*100:.1f}\\%",
        "average": True
    },
      {
        "type": "summary",
        "field": "race/accuracy/group_average",
        "transform": lambda x: f"{x*100:.1f}\\%",
        "average": True
    },
       {
        "type": "summary",
        "field": "siqa/accuracy/group_average",
        "transform": lambda x: f"{x*100:.1f}\\%",
        "average": True
    },
       {
        "type": "summary",
        "field": "winogrande/accuracy/group_average",
        "transform": lambda x: f"{x*100:.1f}\\%",
        "average": True
    },
     {
        "type": "summary",
        "field": "commonsenseqa/accuracy/group_average",
        "transform": lambda x: f"{x*100:.1f}\\%",
        "average": True
    },
