...
from moe_model.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if 'lora' in model_name.lower() and model_base is not None:
        if 'vicuna' in model_base:
            from moe_model.model.language_model.llava_llama import LlavaConfig
            ...
            if '8x' in model_base:
                from moe_model.model.language_model.llava_mixtral import LlavaMixtralConfig
                ...
                from moe_model.model.language_model.llava_mistral import LlavaMistralConfig
        ...
        elif "phi3" in model_name.lower() or "Phi3" in model_name.lower() or True:
    ...
    # luna = getattr(model.config, "luna", False)
    # if luna:
