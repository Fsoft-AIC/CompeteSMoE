...
@register_moe("competesmoev20")
class CompeteSMoEv20(MoeLayer):
    ...
    def init_gate_weights(self):
        pass
        # print("Khởi tạo trọng số và bias của lớp gating.")
        # gate_generator = torch.Generator(device=self.gate.weight.device)
        # gate_generator.manual_seed(42)
        # """
        # Khởi tạo trọng số và bias của lớp gating.
        # """
        # nn.init.normal_(self.gate.weight, 0.0, 0.02, generator=gate_generator)
